...
#include "../3D_scanner/camerawindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_camerawindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 150, 7)
    ...
    "camerawindow\0on_pushButton_clicked\0\0"
    "on_pushButton_2_clicked\0on_pushButton_3_clicked\0"
    "on_pushButton_4_clicked\0on_pushButton_5_clicked\0"
    "on_calib1_clicked\0checked"
};
...
const QMetaObject camerawindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_camerawindow.data,
      qt_meta_data_camerawindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_camerawindow.stringdata))
