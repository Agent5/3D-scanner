...
#include "../3D_scanner/scanwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_scanwindow_t, stringdata) + ofs \
...
const QMetaObject scanwindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_scanwindow.data,
      qt_meta_data_scanwindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_scanwindow.stringdata))
